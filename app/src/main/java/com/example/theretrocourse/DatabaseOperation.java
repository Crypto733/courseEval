...
//Här måste course_table komma upp i databasfilen och om vi ska ha en separat admin table får vi fixa det
public class DatabaseOperation extends SQLiteOpenHelper {
    ...
    public static final String table_name3 ="course_table";
    ...
    public void onCreate(SQLiteDatabase db){
        ...
        db.execSQL("create table "+ table_name3 +"(CourseCode VARCHAR PRIMARY KEY,CourseName TEXT, FOREIGN KEY (BTH_mail) REFERENCES "+ table_name+ "(BTH_mail))");
    }
    ...
    public Cursor findLoginData(String bth_mail, String pass){
        ...
        else if (MainActivity.type.equals("s")){
