...
public class GenerateResultA extends AppCompatActivity {
    DatabaseOperation mydb;
    TextView txt ;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_generate_result2);
        mydb = new DatabaseOperation(this);
        txt = findViewById(R.id.textViewRubric);
        txt.setText(AdminMainPage.text);
        chart1();
        chart2();
        chart3();
        chart4();
    ...
    private void chart1() {
        ...
        while (cursor.moveToNext()){
            if(cursor.getString(1).equals(AdminMainPage.text)){
